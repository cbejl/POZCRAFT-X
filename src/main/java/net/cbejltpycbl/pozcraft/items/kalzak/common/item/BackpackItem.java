package net.cbejltpycbl.pozcraft.items.kalzak.common.item;
...
import static net.cbejltpycbl.pozcraft.items.kalzak.common.BackpackMod.translate;
...
public class BackpackItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(translate("tooltip.kalzak", this.width, this.height, this.width * this.height).formatted(Formatting.GRAY));
